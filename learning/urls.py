# urls.py - Updated with CGPA Calculator routes
...
urlpatterns = [
    ...
    # ── CGPA Calculator ───────────────────────────────────────
    path('cgpa/',                                          views.cgpa_dashboard,  name='cgpa_dashboard'),
    path('cgpa/semester/add/',                             views.semester_create, name='semester_create'),
    path('cgpa/semester/<int:pk>/',                        views.semester_detail, name='semester_detail'),
    path('cgpa/semester/<int:pk>/edit/',                   views.semester_edit,   name='semester_edit'),
    path('cgpa/semester/<int:pk>/delete/',                 views.semester_delete, name='semester_delete'),
    path('cgpa/semester/<int:semester_pk>/course/add/',    views.course_create,   name='course_create'),
    path('cgpa/course/<int:pk>/edit/',                     views.course_edit,     name='course_edit'),
    path('cgpa/course/<int:pk>/delete/',                   views.course_delete,   name='course_delete'),
